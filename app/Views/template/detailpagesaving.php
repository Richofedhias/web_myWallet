...
<body>
  <div class="detailContainer">
    <div class="detailRecord">
      ...
      <h2>Print your Saving Record</h2>
      ...
      <div id="detailTabel">
        <table class="table table-striped" style="width: 100%; border-bottom: brown;">
          ...
          <tr>
            <td><?= $tabungan['nominal_tabungan']; ?></td>
            <td><?= $tabungan['tanggal_tabungan']; ?></td>
            <td><?= $tabungan['detail_tabungan']; ?></td>
          </tr>   
          <?php endforeach; ?>
